...
{    
    if (self = [super initWithFrame:frame])
    {
        ...
        UIImageView* pop_ImageView= [[UIImageView alloc] initWithImage:popoverBackgroundImage];
        self.popoverBackgroundImageView=pop_ImageView;
        [pop_ImageView release];
        [self addSubview:self.popoverBackgroundImageView];
        
        UIImageView* arrow_imgView= [[UIImageView alloc] init];
        self.arrowImageView=arrow_imgView;
        [arrow_imgView release];
...
-(void)dealloc{
    NSLog(@"<<Chao-->KSCustomPopoverBackgroundView-->dealloc-->释放内存");

    if (self.arrowImageView) {
        self.arrowImageView=nil;
    }
    if (self.popoverBackgroundImageView) {
        self.popoverBackgroundImageView=nil;
    }
    [super dealloc];
}
