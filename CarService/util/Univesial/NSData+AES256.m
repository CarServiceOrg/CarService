...
+ (NSString *)AES256DecryptWithCiphertext:(NSString *)ciphertexts{
	...
	if (cryptStatus == kCCSuccess) {
        ...
        NSString *string = [[[NSString alloc] initWithData:encryptData encoding:NSUTF8StringEncoding] autorelease]; 
		return string;
	}
...
- (NSString *)base64Encoding;
{
    ...
    NSString *kString = [[[NSString alloc] initWithBytesNoCopy:characters length:length encoding:NSASCIIStringEncoding freeWhenDone:YES] autorelease];
    return kString;
}
@end
