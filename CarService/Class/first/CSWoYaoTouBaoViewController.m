...
@interface CSWoYaoTouBaoViewController ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation CSWoYaoTouBaoViewController
    ...
    if (imageView && textLabel) {
        switch (indexPath.row) {
            case 0:
            {
                ...
                [textLabel setText:@"电话投保" afterInheritingLabelAttributesAndConfiguringWithBlock:^NSMutableAttributedString *(NSMutableAttributedString *mutableAttributedString) {
...
-(void)pushViewController:(int)index
{
    switch (index) {
        case 0:
        {
            BlockAlertView *alert = [BlockAlertView alertWithTitle:@"电话投保" message:@"是否电话呼叫咨询？"];
        ...
        case 1:
        {
            CSWoYaoTouBaoSubmitViewCtrler* ctrler=[[CSWoYaoTouBaoSubmitViewCtrler alloc] init];
